...
add_action('wp_head', function() {
    ...
    <script type="module" src="<?php echo get_template_directory_uri() . '/app/wjh-dev.esm.js' ?>"></script>
    <script nomodule src="<?php echo get_template_directory_uri() . '/app/wjh-dev.js' ?>"></script>
    <?php
});
...
class WP_Query_Route_To_REST_API extends WP_REST_Posts_Controller {
  ...
  public function register_routes() {
    register_rest_route( 'webpress/v1', 'route/', array(
...
function jp_debug_rewrite_rules() {
